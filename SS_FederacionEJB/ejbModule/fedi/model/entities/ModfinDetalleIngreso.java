...
public class ModfinDetalleIngreso implements Serializable {
	...
	@Id
	@SequenceGenerator(name="MODFIN_DETALLE_INGRESOS_CODDETAINGRESO_GENERATOR", sequenceName="SEQ_MODFIN_DETALLE_INGRESOS",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MODFIN_DETALLE_INGRESOS_CODDETAINGRESO_GENERATOR")
	@Column(name="cod_deta_ingreso", unique=true, nullable=false)
	private Integer codDetaIngreso;
	...
	public Integer getCodDetaIngreso() {
		return this.codDetaIngreso;
	}

	public void setCodDetaIngreso(Integer codDetaIngreso) {
