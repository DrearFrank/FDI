...
public class ModadHorario implements Serializable {
	...
	@Id
	@SequenceGenerator(name="MODAD_HORARIOS_CODHORARIO_GENERATOR", sequenceName="SEQ_MODAD_HORARIOS",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MODAD_HORARIOS_CODHORARIO_GENERATOR")
